...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../projet/css/styles.css">
    </head>
    <body>
        <div class="container site">
           
            <h1 class="text-logo"><span class="bi-shop"></span> Burger Code <span class="bi-shop"></span></h1>
            <div id="admin"><a href="../projet/admin/index.html" class="bi bi-person-circle">Comte admin</a></div>
            <?php
                        ...
                        echo '<div class="col-md-6 col-lg-4">
                                <div class="img-thumbnail">
                                    ...
                                    <div class="caption">
                                        ...
                                        <a href="cart.php" class="btn btn-order" role="button"><span class="bi-cart-fill"></span>Commander</a>
                                    </div>
                                </div>
                            </div>';
                    }
